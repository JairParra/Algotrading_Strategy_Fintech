...
![](outputs/capital_evolution.png){width=45%}\ 
![](outputs/portfolio_performance.png){width=45%}


<!-- ![](outputs/capital_evolution.png){width=50%} -->

<!-- ![](outputs/portfolio_performance.png){width=50%} -->

![](outputs/portfolio_drawdown.png){width=50%}
