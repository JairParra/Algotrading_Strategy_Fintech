...
=======
  ...
  sector_stocks <- lapply(, function(stock) {
...
```{r}
print(head([[1]]$train$month_index, 1)) # beginning month of window 
print(tail([[1]]$val$month_index, 1)) # end month of window
...
=======
                  fmla = fmla, # formula for regression 
                  data = [[1]]$train, # train data for one stock of current sector  
                  target_var = "realized_returns", # y 
                  nvmax = 50, 
                  method="forward")
>>>>>>> Stashed changes
...
=======
  ticker_data_train <- [[ticker]]$train 
  ticker_data_val <- [[ticker]]$val
>>>>>>> Stashed changes
