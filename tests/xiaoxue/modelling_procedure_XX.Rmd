...
simulate the backtesting. You can ignore most of the code here, but some
...
for(ticker in sector_tickers){
  ...
  stock_sharpe <- SharpeRatio(ticker_data_train[, "realized_returns"], Rf=0, FUN="StdDev")
  stock_msr <- SharpeRatio(ticker_data_train[, "realized_returns"], Rf=0, FUN="ES")
